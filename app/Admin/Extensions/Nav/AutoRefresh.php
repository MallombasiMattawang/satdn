...
<li class="dropdown">
    ...
    <ul class="dropdown-menu" style="width: 30px !important;">
        <li><a href="#" class="auto-refresh-trigger" data-interval=2>2 Second</a></li>
        <li><a href="#" class="auto-refresh-trigger" data-interval=5>5 Second</a></li>
        <li><a href="#" class="auto-refresh-trigger" data-interval=10>10 Second</a></li>
        <li><a href="#" class="auto-refresh-trigger" data-interval=30>30 Second</a></li>
        <li><a href="#" class="auto-refresh-trigger" data-interval=60>1 Minute</a></li>
    </ul>
</li>
