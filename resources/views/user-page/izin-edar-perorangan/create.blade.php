            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-auto mt-4">
                    <h1 class="page-header-title">
                        ...
                        Buat Permohonan SATS-DN Perorangan
                    </h1>
                ...
                <div class="card-body">
                    <div class="row gx-3">
                        ...
                        <div class="mb-3 col-md-6">
                            <label class="small mb-1" for="nama_pengirim">Nama / Nama Perusahaan / Nama Lembaga <span class="text-red">(Wajib*)</span></label>
                            <input class="form-control" id="nama_pengirim" name="nama_pengirim" type="text" placeholder="" value="{{ old('nama_pengirim') }}" required>
                        </div>
                        <div class="mb-3 col-md-6">
                            <label class="small mb-1" for="no_ktp_pemohon">NO KTP Pemohon <span class="text-red">(Wajib*)</span></label>
                            <input class="form-control" id="no_ktp_pemohon" name="no_ktp_pemohon" type="text" placeholder="" value="{{ old('no_ktp_pemohon') }}" required>
                        </div>
                        <div class="mb-3 col-md-6">
                            <label class="small mb-1" for="telepon">Telepon <span class="text-red">(Wajib*)</span></label>
                            <input class="form-control" id="telepon" name="telepon" type="text" placeholder="" value="{{ old('telepon') }}" required>
                        </div>
                        <div class="mb-3 col-md-6">
                            <label class="small mb-1" for="fax">FAX <span class="text-info">(Opsional*)</span></label>
                            <input class="form-control" id="fax" name="fax" type="text" placeholder="" value="{{ old('fax') }}">
                        </div>

                        <div class="mb-3 col-md-12">
                            <label class="small mb-1" for="alamat_lengkap">Alamat Lengkap <span class="text-red">(Wajib*)</span></label>
                            <input class="form-control" id="alamat_lengkap" name="alamat_lengkap" type="text" placeholder="" value="{{ old('alamat_lengkap') }}" required>
                        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row gx-3">
                        ...
                        <div class="mb-3 col-md-4">
                            ...
                            <input class="form-control" id="jenis_tsl" name="jenis_tsl" type="text" value="">
                        </div>
                        <div class="mb-3 col-md-4">
                            <label class="small mb-1" for="satuan">Satuan</label>
                            <input class="form-control" id="satuan" name="satuan" type="text" value="">
                        </div>
                        <div class="mb-3 col-md-4">
                            <label class="small mb-1" for="jumlah_kirim">Jumlah (Maks 2 untuk satwa, 10 Batang untuk Anggrek)</label>
