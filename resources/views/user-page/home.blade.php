            ...
            <div class="row">
                ...
                <form class=" d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0">
                    <div class="input-group">
                        <input class="form-control form-search" type="text" placeholder="Cari layanan..." aria-label="Search for..." aria-describedby="btnNavbarSearch" />
                ...
                <div class="row div-search" style="margin: auto !important">
                    <div class="col-xl-3 col-md-6 mb-2">
                        <a class="card lift lift-sm h-100" href="{{ route('izin.edar.perorangan.create') }}">
                            <div class="card-body">
